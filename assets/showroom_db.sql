...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 13, 2019 at 02:50 AM
...
INSERT INTO `berita` (`id_berita`, `id_user`, `id_kategori_berita`, `slug_berita`, `nama_berita`, `keterangan`, `jenis_berita`, `status`, `gambar`, `tanggal_post`, `tanggal`) VALUES
...
CREATE TABLE `produk` (
  ...
  `tipe_bahan_bakar` enum('bensin','solar','diesel') NOT NULL,
  `transmisi` enum('manual','automatic') NOT NULL,
  `kapasitas_mesin` double NOT NULL,
  `tipe_mesin` varchar(250) DEFAULT NULL,
  `diameter_langkah` varchar(250) DEFAULT NULL,
  `perbandingan_kompresi` varchar(250) DEFAULT NULL,
  `daya_maksimum` varchar(250) DEFAULT NULL,
  `torsi_maksimum` varchar(250) DEFAULT NULL,
  `sistem_bahan_bakar` varchar(250) DEFAULT NULL,
  `sistem_transmisi` varchar(250) DEFAULT NULL,
  `dimensi_type_1` varchar(250) DEFAULT NULL,
  `dimensi_type_2` varchar(250) DEFAULT NULL,
  `dimensi_type_3` varchar(250) DEFAULT NULL,
  `jarak_pijak_depan` varchar(250) DEFAULT NULL,
  `jarak_pijak_belakang` varchar(250) DEFAULT NULL,
  `jarak_sumbu_roda` varchar(250) DEFAULT NULL,
  `kapasitas_tangki` varchar(250) DEFAULT NULL,
  `rangka_body` varchar(250) DEFAULT NULL,
  `suspensi_depan` varchar(250) DEFAULT NULL,
  `suspensi_belakang` varchar(250) DEFAULT NULL,
  `rem_depan` varchar(250) DEFAULT NULL,
  `rem_belakang` varchar(250) DEFAULT NULL,
  `sistem_pengereman` varchar(250) DEFAULT NULL,
  `ukuran_ban` varchar(250) NOT NULL,
  `kondisi` enum('baru','bekas') NOT NULL,
  `odo_meter` double DEFAULT NULL,
  `stok` int(11) NOT NULL,
  `satuan` varchar(20) NOT NULL,
  `status_produk` enum('draft','publish') NOT NULL,
  `gambar` varchar(255) NOT NULL,
  `tanggal_post` datetime NOT NULL,
  `tanggal` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
INSERT INTO `produk` (`id_produk`, `id_user`, `id_kategori_produk`, `id_body_type`, `slug_produk`, `nama_produk`, `keterangan`, `harga`, `model`, `tahun`, `tipe_bahan_bakar`, `transmisi`, `kapasitas_mesin`, `tipe_mesin`, `diameter_langkah`, `perbandingan_kompresi`, `daya_maksimum`, `torsi_maksimum`, `sistem_bahan_bakar`, `sistem_transmisi`, `dimensi_type_1`, `dimensi_type_2`, `dimensi_type_3`, `jarak_pijak_depan`, `jarak_pijak_belakang`, `jarak_sumbu_roda`, `kapasitas_tangki`, `rangka_body`, `suspensi_depan`, `suspensi_belakang`, `rem_depan`, `rem_belakang`, `sistem_pengereman`, `ukuran_ban`, `kondisi`, `odo_meter`, `stok`, `satuan`, `status_produk`, `gambar`, `tanggal_post`, `tanggal`, `updated_at`) VALUES
(1, 1, 5, 1, 'expander-ii', 'Expander II', '<p>adada</p>', 12000, '', 0, 'bensin', 'manual', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', 'bekas', NULL, 12000, 'unit', 'publish', 'expander-1.jpg', '2016-06-20 04:27:19', '2019-03-12 21:42:44', '2019-03-12 21:33:46'),
(2, 1, 3, 1, 'toyota-calya-16g-mt', 'Toyota Calya 1.6G MT', '<p>Kambing Otawa</p>', 121000000, '', 0, 'bensin', 'manual', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', 'bekas', NULL, 12, 'unit', 'publish', 'toyota-calya.jpg', '2016-06-20 04:53:40', '2019-03-12 21:42:44', '2019-03-12 21:33:46'),
(3, 1, 4, 3, 'honda-brio-harga-murah-2019', 'Honda Brio Harga Murah 2019', '<p>Ikan Lele Dumbo</p>', 164000000, '', 2017, 'bensin', 'manual', 1200, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', 'bekas', NULL, 100, 'unit', 'publish', 'Honda_Brio_L_1.jpg', '2016-06-20 04:58:41', '2019-03-12 21:33:46', '2019-03-12 21:33:46'),
(4, 1, 4, 3, 'honda-brio-harga-murah-2019', 'Honda Brio Harga Murah 2019', '<p>fadsfa</p>', 5600000, '', 2016, 'bensin', 'manual', 1200, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', 'bekas', NULL, 10, 'unit', 'publish', 'seat-cushion-1099622_1920.jpg', '2019-03-04 22:59:01', '2019-03-12 21:33:46', '2019-03-12 21:33:46'),
(5, 1, 4, 1, 'mobilio', 'Mobilio', '<p>Mobilio keren banget lho..</p>', 120000000, '', 2015, 'bensin', 'manual', 1494, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', 'bekas', NULL, 1, 'unit', 'publish', 'honda-mobilio1.jpg', '0000-00-00 00:00:00', '2019-03-12 21:33:46', '2019-03-12 21:33:46');
...
(1, 'Fullname admin', 'admin@admin.com', 'admin', '$2y$10$iGnW0.43xDRacPcdnDZxZeXYloVSY6peIjp4PLdMbtAdV3AGO3Uh.', 'Admin');

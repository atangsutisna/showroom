    ...
    <div class="col-md-12 col-lg-12 col-sm-12 col-12">
        <div class="panel panel-default">   
            <div class="panel-body">
                <?= form_open_multipart('admin/produk/tambah', 'class="form-horizontal"'); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-sm-8 col-8">
                            <?= form_dropdown('id_kategori_produk', $cat_choices, NULL, "class=\"form-control\""); ?>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4 col-sm-4 col-4">
                            <?= form_dropdown('status_produk', $status_choices, NULL, "class=\"form-control\""); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-4 col-sm-4 col-4">
                            <input type="number" name="harga" class="form-control" 
                                placeholder="Harga produk" value="<?php echo set_value('harga') ?>" required>
                        </div>
                        <div class="col-lg-2 col-sm-2 col-2" style="padding-left: 0px;">
                            <?= form_dropdown('satuan', $unit_choices, NULL, "class=\"form-control\""); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-4 col-sm-4 col-4">
                            <input type="number" name="stok" class="form-control" 
                                placeholder="Stok produk" value="<?php echo set_value('stok') ?>" required>
                        </div>
                    </div>
                    <div class="form-group">

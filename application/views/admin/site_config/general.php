    ...
    <div class="row">
        <div class="col-6 col-md-6 col-lg-6">
            ...
            <div class="form-group">
                ...
                <input type="url" name="website" placeholder="<?php echo base_url() ?>" 
            ...
            <div class="form-group">
                <label>Fax</label>
                <input type="text" name="fax" placeholder="021-000000" 
                    value="<?php echo $site['fax'] ?>" class="form-control">
            </div>
            <div class="form-group">
        ...
        <div class="col-6 col-md-6 col-lg-6">
            <h3>Modul SEO </h3>
            <small>Search Engine Optimization</small><hr>
            <div class="form-group">
